"""
  References:
  - https://github.com/hkproj/pytorch-transformer/blob/main/dataset.py
"""
import torch
...
class BilingualDataset(Dataset):
  ...
  def __getitem__(self, idx):
    ...
    return {
      ...
      'encoder_mask': (encoder_input != self.pad_token).view(1, 1, self.seq_len),
      'decoder_mask': (decoder_input != self.pad_token).view(1, 1, self.seq_len) & causal_mask(decoder_input.size(0)),
      'label': label,
      'src_text': src_text,
      'tgt_text': tgt_text,
    }
